...
const serviceIcons = {
  FaCode: <FaCode size={32} className="text-yellow-400"/>,
  FaChartBar: <FaChartBar size={32} className="text-yellow-400"/>,
  FaSatelliteDish: <FaSatelliteDish size={32} className="text-yellow-400"/>,
  FaHelicopter: <FaHelicopter size={32} className="text-yellow-400"/>,
  FaDatabase: <FaDatabase size={32} className="text-yellow-400"/>,
  FaLightbulb: <FaLightbulb size={32} className="text-yellow-400"/>,
  FaLaptopCode: <FaLaptopCode size={32} className="text-yellow-400"/>,
  FaCube: <FaCube size={32} className="text-yellow-400"/>,
...
const ServicesPage = () => {
  ...
  const getSolutionIcon = (id) => {
    switch (id) {
        ...
        case 'real-estate': return <FaCity />; // New icon
    ...
    <div className="py-16 md:py-20 bg-gray-900 text-white">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-20 md:mt-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {solutions.map(solution => (<Card key={solution.id} title={solution.title} icon={getSolutionIcon(solution.id)}>{solution.description}</Card>))}
            </div>
        </div>
      </div>
    </div>
