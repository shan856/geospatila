      ...
      {editingProject && (
        <div className="bg-gray-800 p-6 rounded-lg mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input value={editingProject.imageUrl} onChange={(e) => setEditingProject({...editingProject, imageUrl: e.target.value})} placeholder="Image URL (e.g., https://...)" className="col-span-1 p-2 bg-gray-700 rounded text-white" />
