...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Email',
      href: 'mailto:contact@rrtechgeo.com',
      icon: (
      ...
      <div className="container-custom py-12 relative z-10">
          ...
          <div className="lg:col-span-4">
            <Link to="/" className="flex items-center gap-3 mb-6 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-text-muted uppercase tracking-widest">Geospatial Solutions</span>
              </div>
            </Link>
            <p className="text-text-secondary mb-8 leading-relaxed max-w-sm">
              Transforming geospatial data into actionable insights. Expert GIS solutions,
              drone mapping, and remote sensing services for modern businesses.
            </p>
        ...
        <div className="pt-8 border-t border-glass-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text-muted text-sm">
            © 2024 RRtechGeo. All rights reserved.
          </p>
          <div className="flex flex-wrap justify-center gap-6">
            <Link to="#" className="text-text-muted hover:text-accent text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link to="#" className="text-text-muted hover:text-accent text-sm transition-colors">
              Terms of Service
